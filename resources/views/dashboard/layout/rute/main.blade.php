...
function initMap() {
            var places = @json($findlocation);///importing from database to json
        ...
        $.each( places, function( index, value ){
          ...
          var popupmarker = '<table>\
                    ...
                    <tr>\
                        <td colspan="2"><strong>name</strong><br />' + value.nama_tempat + '</td>\
                    </tr>\
                    <tr>\
                        <th scope="row">kecamatan</th>\
          ...
          var marker = L.marker(L.latLng(value.latitude,value.longtitude),{icon: tps}).addTo(map);
