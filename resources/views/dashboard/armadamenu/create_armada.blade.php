...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <h5 class="m-0 font-weight-bold text-primary">Tambah Data Armada :</h5>
  </div>
<div class="container p-md-3">
  <form method="post" action="{{ route('armada.store') }}" >
    ...
    <div class="col-12">
      ...
      <input type="text" class="form-control @error('nama_sopir') is-invalid @enderror" id="nama" name="nama_sopir" placeholder="Nama Supir baru">
      @error('nama_sopir')
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" placeholder="status kepegawaian" >
        @error('status')
        <div class="invalid-feedback">
        {{ $message }}
          </div>  
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control @error('no_pol') is-invalid @enderror" name="no_pol" placeholder="Nomor Polisi">
        @error('no_pol')
        <div class="invalid-feedback">
        {{ $message }}
          </div>  
    ...
    <div class="col-4">
      ...
      <input type="text" class="form-control @error('no_lambung') is-invalid @enderror" id="no_lambung" name="no_lambung" placeholder="No Lambung">
      @error('no_lambung')
      <div class="invalid-feedback">
      {{ $message }}
        </div>  
